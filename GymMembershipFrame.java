...
public GymMembershipFrame(){
    ...
    clientsPnl.setBorder(new TitledBorder(new LineBorder(Color.BLACK, 1), "Client details"));
...
idPnl.add(idNoLbl);
idPnl.add(idNoTxtFld);

genderPnl.add(genderLbl);
genderPnl.add(genderComboBox);

clientsPnl.add(namePnl);              //--> second collective panel
...
headingClientCombinedPnl.add(clientsPnl, BorderLayout.CENTER);
